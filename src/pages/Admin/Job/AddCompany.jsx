...
//     try {
//       setLoading(true);
//       const response = await axios.post("http://localhost:5000/api/v1/companies/", payload);
...
//           {/* Mission */}
//           <div>
//             <label className="block text-gray-700 font-semibold">Mission</label>
//             <input
//               type="text"
//               name="mission"
...
//             <div>
//               <label className="block text-gray-700 font-semibold">Founded Year</label>
//               <input
//                 type="number"
//                 name="foundedYear"
...
//             </div>
//             <div>
//               <label className="block text-gray-700 font-semibold">Industry</label>
//               <input
//                 type="text"
//                 name="industry"
...
//           <div className="grid grid-cols-2 gap-4">
//             <div>
//               <label className="block text-gray-700 font-semibold">Company Size</label>
//               <input
//                 type="text"
//                 name="companySize"
...
//             </div>
//             <div>
//               <label className="block text-gray-700 font-semibold">Headquarters</label>
//               <input
//                 type="text"
//                 name="headquarters"
...
//           {/* Culture */}
//           <div>
//             <label className="block text-gray-700 font-semibold">Culture (comma separated)</label>
//             <input
//               type="text"
//               name="culture"
...
//           {/* Benefits */}
//           <div>
//             <label className="block text-gray-700 font-semibold">Benefits & Perks (comma separated)</label>
//             <input
//               type="text"
...
//           <div className="grid grid-cols-2 gap-4">
//             <div>
//               <label className="block text-gray-700 font-semibold">Logo URL</label>
//               <input
//                 type="text"
//                 name="logoUrl"
