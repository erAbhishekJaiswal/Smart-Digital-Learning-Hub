        ...
        <div className="footer-columns-container">
          ...
          <div className="footer-col col-2">
            ...
            <div className="contact-item">
              ...
              <p> <a href="tel:+917725094078">+91 7725094078</a> / <a href="tel:+918451924078">+91 8451924078</a></p>
            </div>
            <div className="contact-item">
              <FontAwesomeIcon icon={faEnvelope} />
              <p> <a href="mailto:info@kumarinfotech.net">info@kumarinfotech.net</a><br /> <a href="mailto:info.kumarinfotech@gmail.com">info.kumarinfotech@gmail.com</a><br /> <a href="mailto:hr@kumarinfotech.net">hr@kumarinfotech.net</a></p>
            </div>
            <div className="contact-item">
          ...
          <div className="footer-col col-3">
            ...
            <ul className="quick-links-list">
              ...
              <li><a href="https://www.kumarinfotech.net/gallery">gallery</a></li>
              <li><a href="https://www.kumarinfotech.net/privacypolicy">Privacy Policy</a></li>
              <li><a href="https://www.kumarinfotech.net/refer-a-friend">Refer A Friend</a></li>
              <li><a href="https://www.kumarinfotech.net/details_enq_std">Enquiry Form</a></li>
              <li><a href="https://www.kumarinfotech.net/grabdeals-terms-conditions">Grab Deals - terms & conditions</a></li>
            </ul>
            <ul className="quick-links-list second-list">
              ...
              <li><a href="https://www.kumarinfotech.net/faq">FAQ</a></li>
          ...
          <div className="footer-col col-4">
            ...
            <div className="social-icons">
              ...
              <a href="https://www.linkedin.com/in/kumarinfotech20" className="social-icon"><FontAwesomeIcon icon={faLinkedinIn} /></a>
